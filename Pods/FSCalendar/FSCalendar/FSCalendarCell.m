...
//    int step = 500;
//    //CGFloat diameter = MIN(self.bounds.size.height*04.0/6.0,self.bounds.size.width);
//    switch step {
//        case 0:
//        CGFloat diameter = MIN(self.bounds.size.height * 3,self.bounds.size.width * 3);
//        case 1..<10:
...
//
   // self.rangeValue = 2.0;
    CGFloat diameter = MIN(self.bounds.size.height * self.rangeValue,self.bounds.size.width * self.rangeValue);
  
    diameter = diameter > FSCalendarStandardCellDiameter ? (diameter - (diameter-FSCalendarStandardCellDiameter)*0.5) : diameter;
  
  //  CGFloat diameter = MIN(self.bounds.size.height * 0.5,self.bounds.size.width * 0.5);
//    diameter = diameter > FSCalendarStandardCellDiameter ? (diameter - (diameter-FSCalendarStandardCellDiameter)*0.5) : diameter;
 ...
 // _shapeLayer.frame = CGRectMake((self.bounds.size.width-diameter)/2 + (diameter / 2 / 2),
  //  (titleHeight-diameter)/2 + (diameter / 2 / 2), diameter / 2, diameter / 2);
   ...
   // _shapeLayer.frame = CGRectMake((self.bounds.size.width-diameter)/2 + (diameter / 2 / 2), (titleHeight-diameter)/2 + (diameter / 2 / 2), 80, 80);
    
   // _shapeLayer.frame = CGRectMake(  self.bounds.origin.x / 2 - 10, self.bounds.origin.y / 2 - 20, 30, 30);
